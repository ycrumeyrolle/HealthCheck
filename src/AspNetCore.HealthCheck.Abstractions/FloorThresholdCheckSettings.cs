...
{
    public class FloorThresholdCheckSettings : ThresholdCheckSettings
    {
        public FloorThresholdCheckSettings(string name, bool critical, int frequency, IEnumerable<string> tags, long errorThreshold, long warningThreshold)
